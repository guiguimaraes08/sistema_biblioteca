...
public class CadastroFunc extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (titulo.isEmpty() || autor.isEmpty() || editora.isEmpty() || anoPublicacao.isEmpty() || status.isEmpty()) {
            ...
            try {
                ...
                // SQL para inserir dados na tabela 'livros'
                ...
                try {
                    stmt.setInt(4, Integer.parseInt(anoPublicacao));
                } catch (NumberFormatException e) {
                    throw new SQLException("Ano de publicação deve ser um número.", e);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFunc.class
