 ...
 * @author gui_g
 */
public class DevoluçãoFunc extends javax.swing.JFrame {

    /**
     * Creates new form Cadastro
     */
    public DevoluçãoFunc() {
        initComponents();
    }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (codigoLivro.isEmpty() || idUsuario.isEmpty() || dataDevolucaoStr.isEmpty()) {
            ...
            try {
                ...
                RelatorioFunc relat = new RelatorioFunc();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DevoluçãoFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DevoluçãoFunc().setVisible(true);
            }
        });
    }
